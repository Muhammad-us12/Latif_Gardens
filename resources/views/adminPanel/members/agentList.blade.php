                                            ...
                                            <table id="scroll-horizontal-datatable" class="table table-centered w-100 nowrap">
                                                ...
                                                @isset($agentData)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="public/images/persons/{{ $agent_res->picture }}" style="width:100px; height:100px" alt="contact-img" title="contact-img" class="rounded me-3" height="48" />                                                           
                                                        </td>
                                                       
                                                        <td>
                                                        {{ $agent_res->fname." ".$agent_res->lname }}
                                                        </td>
                                                        <td>
                                                            {{ $agent_res->email }}
                                                        </td>
                                                        <td>
                                                            @if($agent_res->display_on_web)
                                                                {{ "Yes" }}
                                                            @endif
                                                            
                                                        </td>
                                                        <td>
                                                            {{ number_format($agent_res->opening_bal) }}
                                                        </td>
                                                        <td>
                                                            {{ number_format($agent_res->balance) }}
                                                        </td>
                                                        <td class="change_user">
                                                                @php
                                                                     if($agent_res->status !== 'active'){
                                                                        $isActive = false;
                                                                     }else{
                                                                        $isActive = true;
                                                                     }
                                                                ...
                                                                <span  onclick="updateUserStatus({{ $agent_res->id }},'{{ $agent_res->status }}')" @class([
                                                                        'badge',
                                                                        'bg-success' => $isActive,
                                                                        'bg-danger' => ! $isActive,
                                                                    ])>{{ $agent_res->status  }}
                                                        ...
                                                        <a href="{{ URL::to('agent-ledeger/'.$agent_res->id.'') }}" class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                                        <a href="{{ URL::to('agents-profile/1') }}" class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                                            <a href="{{ URL::to('agent-update/'.$agent_res->id.'') }}" class="action-icon text-success"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                        </td>
                                                    </tr>
