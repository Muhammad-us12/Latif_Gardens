                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ URL::to('plots-submit') }}" method="post">
                                            @csrf
                                            <div class="row mb-2">
                                              
                                                <div class="col-sm-4">
                                                    <div class="mb-3">
                                                        <label for="example-input-normal" class="form-label">Plot No.</label>
                                                        <input type="text" id="example-input-normal" name="plot_no" value="{{ old('plot_no') }}" class="form-control" placeholder="Plot No">
                                                        @error('plot_no')
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" id="example-input-normal" name="plot_cost_price" value="{{ old('plot_cost_price') }}" class="form-control" placeholder="Purchase Amount">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control date" name="plot_sale_price" value="{{ old('plot_sale_price') }}" >
