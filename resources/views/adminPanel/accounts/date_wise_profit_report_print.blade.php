...
@extends('adminPanel/print_master')   
    @section('content')
    <h3 style="margin-top:40px;">Date Wise Profit Report</h3>
        ...
        <div class="row pl-5 pr-5">
            ...
            <div class="col-md-9"><h6>Start Date: {{ $request->start_date }}</h6></div>
            <div class="col-md-3"><h6>End Date: {{ $request->end_date }}</h6></div>
        </div>
