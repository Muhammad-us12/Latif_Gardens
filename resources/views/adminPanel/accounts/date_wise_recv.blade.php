...
@extends('adminPanel/print_master')   
    @section('content')
    <h3 style="margin-top:40px;">Date wise Payments Received report</h3>
                ...
                <tbody style="border: 2px solid black;">
                    ...
                    @isset($payments_data)
                        ...
                        <tr>
                            ...
                            <td style="border:1px solid black;">{{ number_format($pay_res->total_received) }}</td>
                        </tr> 
                        @php 
                            $total_amount += $pay_res->total_received;
                        @endphp  
                        @endforeach 
                    @endisset  
