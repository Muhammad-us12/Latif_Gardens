...
@extends('adminPanel/print_master')   
    ...
    <h3 style="margin-top:40px;">Payments Received Voucher</h3>
        ...
        <div class="row pl-5 pr-5">
            ...
            <div class="col-md-9"><h6>Received ID: {{ $payment_data->id }}</h6></div>
            <div class="col-md-3"><h6>Payment From: {{ $payment_data->receivedFrom->account_name; }}</h6></div>
		...
		<table class="table table-sm table-hover table-bordered" style="border: 2px solid black;">
            ...
            <tbody style="border: 2px solid black;">
                     <tr>
                        ...
                        <td style="border:1px solid black;">{{ $payment_data->receivedFrom->account_name; }}</td>
                        <td style="border:1px solid black;"></td>
                        <td style="border:1px solid black;"></td>
                        <td style="border:1px solid black;">{{ number_format($payment_data->total_received) }}</td>
                        <td style="border:1px solid black;"></td>
                     </tr>    
            ...
            <tfoot>
                <tr class="font-weight-bold" style="background-color: #f0eded !important; font-size: 20px;">
                                                    ...
                                                    <td style="border:1px solid black;"></td>
                                                    <td style="border:1px solid black;"></td>
                                                    <td style="border:1px solid black;">{{ Helper::getAmountInWords($payment_data->total_received) }}</td>
                                                    <td style="border:1px solid black;"></td>
                                                        <td style="border:1px solid black;">{{ number_format($payment_data->total_received) }}</td>
