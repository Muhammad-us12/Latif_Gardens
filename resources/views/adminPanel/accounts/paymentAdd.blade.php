                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="text-sm-end">
                                                    <a href="{{ URL::to('payments-list') }}" class="btn btn-success" ><i class="mdi mdi-plus-circle me-2"></i>Payments List</a>
                                                </div>
                                            </div><!-- end col-->
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                            <form action="{{ URL::to('payments-sub') }}" id="payment_from_sub" method="post" data-select2-id="6">
                                                @csrf
