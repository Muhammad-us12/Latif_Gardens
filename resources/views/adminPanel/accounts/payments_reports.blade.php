                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane show active" id="date_wise_pay">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12"><h5>Date Wise Payment Report</h5></div>
                                                                <div class="col-md-12">
                                                    ...
                                                    <div class="tab-pane" id="date_wise_recv">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12"><h5>Date Wise Received Payments Report</h5></div>
                                                                <div class="col-md-12">
                                                    ...
                                                    <div class="tab-pane" id="date_wise_recv_pay">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-10"><h5>Payable & Receivable Report</h5></div>
                                                            <div class="col-md-2">
                                                                <a href="{{ URL::to('payable_receivable') }}" target="blank" class="btn btn-success">Print</a>
                                                            </div>
                                                        </div>
                                                    </div>
