...
@extends('adminPanel/print_master')   
    ...
    <h3 style="margin-top:40px;">Expense Voucher</h3>
        ...
        <div class="row pl-5 pr-5">
            ...
            <div class="col-md-9"><h6>User: {{ Helper::getUserName($expense_data->user_id) }}</h6></div>
            <div class="col-md-3"><h6>Expense Date: {{ date('d-m-Y',strtotime($expense_data->date)) }}</h6></div>
            <div class="col-md-9"><h6>Expense ID: {{ $expense_data->id }}</h6></div>
            <div class="col-md-3"><h6>Expense Type: {{ $expense_data->expenseCategory->exp_category_name }}</h6></div>
