                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane show active" id="category_wise">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12"><h5>Cagetory Wise Expense Report</h5></div>
                                                            <div class="col-md-12">
                                                    ...
                                                    <div class="tab-pane" id="sub_category_wise">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12"><h5>Sub Cagetory Wise Expense Report</h5></div>
                                                                <div class="col-md-12">
                                                    ...
                                                    <div class="tab-pane" id="date_wise_expense">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12"><h5>Date Wise Expense Report</h5></div>
                                                                <div class="col-md-12">
